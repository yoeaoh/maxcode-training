...
// Ещё, скорее всего, в стек попадает не сам таймаут или интервал, а его коллбэк, поэтому
// не важно, в какой последовательности они были созданы, в стек попадёт первый завершённый коллбэк
